...
import { collection, doc, getDocs, getDoc, onSnapshot, deleteDoc, query, where } from "firebase/firestore";
        ...
        <AlertDialogContent>
          ...
          <AlertDialogDescription>
            {singleDeviceOnly && myDevices.some((d) => d.id === confirmKick?.id)
              ? "The other device will see slot full. This device will then be used for this company."
              : "That device will be removed from the list and will see slot full (no logout)."}
          </AlertDialogDescription>
          <AlertDialogFooter>
