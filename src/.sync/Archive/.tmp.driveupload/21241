      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <div className="flex flex-wrap items-end gap-3">
            ...
            <span className="inline-flex items-center h-9 px-3 rounded-md border border-input bg-muted/50 text-sm text-muted-foreground shrink-0">{deviceHistory.length} entries (keeping up to {companyHistoryLimit})</span>
          </div>
