    ...
    return (
      <div className="absolute inset-0 z-50 flex flex-col items-center justify-center gap-4 bg-background/95 backdrop-blur-sm p-6 overflow-y-auto">
        ...
        <p className="text-center text-muted-foreground text-sm max-w-sm">
          You have another device logged in to this company. Kick that device from Settings → Synced devices, or use this device again to rejoin.
        </p>
        <div className="flex flex-wrap items-center justify-center gap-3">
          <Button onClick={() => clearKickedAndRefresh()} className="bg-primary text-primary-foreground hover:bg-primary/90">
            Use this device again
          </Button>
          <Link href="/settings?view=devices" className="inline-flex items-center justify-center rounded-md border border-input bg-background px-4 py-2 text-sm font-medium hover:bg-accent">
            Settings → Synced devices
          </Link>
