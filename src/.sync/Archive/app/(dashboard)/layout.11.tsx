      ...
      <div className="absolute inset-0 z-50 flex flex-col items-center justify-center gap-4 bg-background/95 backdrop-blur-sm p-6 overflow-y-auto">
        ...
        <AlertDialog open={!!confirmKick} onOpenChange={(open) => !open && setConfirmKick(null)}>
          <AlertDialogContent>
            ...
            <AlertDialogDescription>
              That device will be removed and this device will be added in its place. You will stay in the company on this device.
            </AlertDialogDescription>
            <AlertDialogFooter>
              <AlertDialogCancel>Cancel</AlertDialogCancel>
              <AlertDialogAction
                className="bg-destructive text-destructive-foreground hover:bg-destructive/90"
                onClick={() => confirmKick && handleKickOut(confirmKick, () => clearKickedAndRefresh())}
              >
                Kick out
              </AlertDialogAction>
            </AlertDialogFooter>
