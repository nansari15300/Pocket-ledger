...
function DeviceLimitOverlay() {
  ...
  const { deviceLimitReached, singleDeviceOnly, replaceOffer, noPermissionNewDevice, deviceCount, maxDevices, refreshDeviceCheck, performReplaceAndRefresh } = useDeviceLimitContext();
