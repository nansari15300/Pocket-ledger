              ...
              <TableBody>
                {sortedDevices.map((device) => {
                  ...
                  <TableRow key={device.id}>
                    ...
                    <TableCell className="text-sm text-muted-foreground tabular-nums min-w-[11rem] w-[11rem] font-mono">
                      {device.lastActive ? formatLastActive(device.lastActive) : "—"}
                    </TableCell>
                ...
                {deviceHistory.map((row) => {
                  ...
                  return (
                    <TableRow key={row.id}>
                      ...
                      <TableCell className="text-sm text-muted-foreground tabular-nums min-w-[11rem] w-[11rem] font-mono">{row.lastActive ? formatLastActive(row.lastActive) : "—"}</TableCell>
                      <TableCell className="text-sm text-muted-foreground tabular-nums min-w-[11rem] w-[11rem] font-mono">{row.createdAt ? formatLastActive(row.createdAt) : "—"}</TableCell>
                      <TableCell className="text-muted-foreground">
