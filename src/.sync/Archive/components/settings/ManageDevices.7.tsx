                ...
                {sortedDevices.map((device) => {
                  ...
                  <TableRow key={device.id}>
                    <TableCell className="text-sm" title={device.id}>
                      {device.deviceLabel || (device.deviceType === "mobile" ? "Mobile" : device.deviceType === "desktop" ? "Desktop" : "Device")}
                    </TableCell>
                  ...
                  return (
                    <TableRow key={row.id}>
                      <TableCell className="text-sm" title={row.deviceId}>
                        {row.deviceLabel || (row.deviceType === "mobile" ? "Mobile" : row.deviceType === "desktop" ? "Desktop" : "Device")}
                      </TableCell>
