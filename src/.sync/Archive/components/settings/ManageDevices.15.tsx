...
export function ManageDevices() {
  ...
  const handleRemoveThisDevice = async () => {
    ...
    try {
      ...
      // signOut happens inside removeThisDevice; user will be redirected to login
    } catch (e: unknown) {
      ...
      <div className="space-y-8">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Remove this device from the company to free a slot. You will be signed out on this device and can sign in again if within the plan limit.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 rounded-lg border p-4">
              ...
              >
                ...
                <span className="ml-2">Remove this device and sign out</span>
              </Button>
            </div>
          </CardContent>
        </Card>
