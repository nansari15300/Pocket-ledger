...
export function usePageMemory<T extends { id: string }>(
  ...
  // When urlSelectedId is provided (e.g. ?view= from URL), do not overwrite activeView from localStorage.
  useEffect(() => {
  ...
  }, [isLoading, storageKey, activeView, setActiveView, urlSelectedId, currentItems]); // Removed currentItems to be safe
