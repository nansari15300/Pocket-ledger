  ...
  return (
    <div className="p-4 sm:p-6 md:p-8 space-y-4">
      <Card>
        <CardHeader>
          <div className="flex justify-between items-center">
            <div>
              ...
              <CardDescription>A detailed list of all purchase transactions.</CardDescription>
            </div>
        ...
        <CardContent>
          <TransactionsTable transactions={purchaseVouchers} context="daybook" userNames={userNames} />
        </CardContent>
      </Card>
    </div>
  );
