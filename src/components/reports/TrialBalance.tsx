                    ...
                    <PopoverContent className="w-auto p-0" align="start">
                      <Calendar
                        ...
                        onSelect={(range) => {
                          let newRange = range;
                          if (range?.from) {
                            const from = new Date(range.from.getFullYear(), range.from.getMonth(), range.from.getDate(), 12);
                            let to = range.to ? new Date(range.to.getFullYear(), range.to.getMonth(), range.to.getDate(), 12) : undefined;
                            newRange = { from, to };
                          }
