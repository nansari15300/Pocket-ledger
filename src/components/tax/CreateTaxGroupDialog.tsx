...
export function CreateTaxGroupDialog({
  onGroupCreated,
  children,
  isOpen,
  onOpenChange,
  ...
  const resetForm = () => {
    setChainSlots([{}]);
    setSystemBranch(TAX_ENTITY_GROUP_PRESET.defaultBranch);
  };
  ...
  useEffect(() => {
    ...
    document.addEventListener(
      TAX_ENTITY_GROUP_PRESET.prefillEventName,
