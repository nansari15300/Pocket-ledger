...
function shouldBlockDismissForInAppAttachmentPreview(ev: { detail?: { originalEvent?: Event } }): boolean {
  ...
  if (t instanceof Element) {
    if (
      t.closest(
        `[data-in-app-pdf-preview], [data-in-app-image-preview], [data-attachment-preview-portal], [data-attachment-preview-backdrop], [${IN_APP_ATTACHMENT_PREVIEW_CLICK_SHIELD}]`
      )
    )
      return true
  }
