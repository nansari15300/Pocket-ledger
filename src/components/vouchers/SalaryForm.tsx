              ...
              <>
                ...
                <div className="flex gap-2 md:gap-4 [&_button]:h-10">
                  ...
                  {showApproveButton && onApprove && (
                    <Button type="button" variant="default" onClick={async (e) => { e.preventDefault(); if (isFormDirty) await handleFormSubmit(e, { approveAfterSave: true }); else onApprove(); }} disabled={isApproving} className="w-full md:w-auto shrink-0">
