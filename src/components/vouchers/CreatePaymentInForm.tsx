    ...
    try {
      ...
      if (savedDoc && savedDoc.id) {
        ...
        if (approveAfterSave && savedDoc?.id && !voucher?.id) {
          ...
          sonnerToast.success("Receipt saved and approved.", { id: toastId });
        } else {
            ...
            {isMobile ? (
              ...
              <>
                ...
                <div className="flex gap-2 justify-end [&_button]:h-10">
                  ...
                  {showSaveAndApproveOnCreate && (
                    <Button type="button" onClick={(e) => handleFormSubmit(e, { approveAfterSave: true })} disabled={isLoading || editingDisabled}>
                      {isLoading && <Loader2 className="mr-2 h-4 w-4 animate-spin" />}
                      Save & Approve
                    </Button>
                  )}
