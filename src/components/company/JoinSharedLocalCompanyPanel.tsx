    ...
    >
      {!embedded ? (
        <div>
          <p className="flex items-center gap-2 text-base font-semibold">
            ...
            {/* Lamba help text — (i) popover me (mobile full width ke liye) */}
            <CloudSyncHelpPopover
              label="Join shared local company"
              description={
                <p>
                  Your own companies under My Drive → Pocket Ledger, plus folders others shared with your Gmail. Use the
                  same Gmail as Firebase login. If empty after sync, Connect Google Drive again then Refresh list.
                </p>
              }
            />
          </p>
      ...
      <div className="flex flex-wrap items-center gap-2">
        ...
        {ownedInvites.length > 0 ? (
          ...
          >
            {/* Arrow ko boxed button + clear label do, taaki PC/web/static sab me discoverable rahe. */}
      ...
      {loading ? (
        ...
        <div className="space-y-4">
          {ownedInvites.length > 0 && ownedDriveListOpen ? (
