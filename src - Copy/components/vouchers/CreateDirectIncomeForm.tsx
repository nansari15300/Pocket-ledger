        ...
        <form onSubmit={(e) => handleFormSubmit(e)} className="h-full flex flex-col">
          <ScrollArea className="flex-1 pr-6 -mr-6">
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                {payeeType === 'other' && (
                     <FormField control={form.control} name="payeeName" render={({ field }: any) => (<FormItem><FormControl><Input placeholder="Enter source name" {...field} /></FormControl><FormMessage /></FormItem>)} />
                )}
          ...
          <div className="flex flex-col md:flex-row justify-between items-stretch md:items-center gap-4 pt-4 border-t">
            ...
            <div className={cn(
              ...
              <Button type="button" variant="outline" onClick={() => voucher ? onVoucherUpdated?.() : onVoucherCreated?.()} className="w-full">
                Cancel
              </Button>
               {!voucher && (
                 <Button type="button" onClick={(e) => handleFormSubmit(e, { saveAndNew: true })} disabled={isLoading} className="w-full">
