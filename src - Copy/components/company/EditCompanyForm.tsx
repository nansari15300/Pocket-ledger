                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <FormField
                        ...
                        render={({ field }: any) => (
                            ...
                            <div className="relative">
                                <FormControl>
                                    <Input type={showNewPassword ? "text" : "password"} placeholder="Set a password to protect this company" {...field} />
                                </FormControl>
                        ...
                        <FormField
                            ...
                            render={({ field }: any) => (
                                ...
                                <div className="relative max-w-sm">
                                    <FormControl>
                                        <Input type={showConfirmPasswordToSave ? "text" : "password"} placeholder="Enter current password to authorize" {...field} />
                                    </FormControl>
