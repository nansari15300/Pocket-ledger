            ...
            <Table>
              ...
              <TableBody>
                <TableRow>
                  ...
                  <TableCell className="text-right">{formatCurrency(gstr3bData.sales.taxableAmount, { noAnimation: true })}</TableCell>
                  <TableCell className="text-right">{formatCurrency(gstr3bData.sales.taxAmount, { noAnimation: true })}</TableCell>
                  <TableCell className="text-right">{formatCurrency(gstr3bData.sales.totalAmount, { noAnimation: true })}</TableCell>
                </TableRow>
                <TableRow>
                  ...
                  <TableCell className="text-right">{formatCurrency(gstr3bData.purchases.taxableAmount, { noAnimation: true })}</TableCell>
                  <TableCell className="text-right">{formatCurrency(gstr3bData.purchases.taxAmount, { noAnimation: true })}</TableCell>
                  <TableCell className="text-right">{formatCurrency(gstr3bData.purchases.totalAmount, { noAnimation: true })}</TableCell>
                </TableRow>
                <TableRow className="bg-muted font-bold">
                  <TableCell>Net Tax Payable</TableCell>
                  <TableCell colSpan={3}></TableCell>
                  <TableCell className="text-right">{formatCurrency(gstr3bData.netTax, { noAnimation: true })}</TableCell>
                </TableRow>
              </TableBody>
            </Table>
          </ScrollArea>
